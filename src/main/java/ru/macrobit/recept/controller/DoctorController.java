...
public class DoctorController {
    ...
    public Object getByQuery(@QueryParam("query") String jsonQuery,
        ...
        return doctorService.find(jsonQuery == null ? null : Recept.MAPPER.readValue(jsonQuery, JsonNode.class), skip, limit, count, sortProperties, sortDirection, ctx.getCurrentUser());
    }
